...
class instagramBot:
    ...
    def seguidores(self, perfil_instagram):
        ...
        if page == 'followers':
            sessao_total_seguidores = driver.find_element(By.XPATH, '/html/body/div[1]/div/div[1]/div/div[1]/div/div/div[1]/div[1]/section/main/div/header/section/ul/li[2]/a/div/span')
        if page == 'following':
            sessao_total_seguidores = driver.find_element(By.XPATH, '/html/body/div[1]/div/div[1]/div/div[1]/div/div/div[1]/div[1]/section/main/div/header/section/ul/li[3]/a/div/span')
        ...
        for i in range(1, int(total_seguidores)):
            time.sleep(3)
            sessao_nomes_seguidores = driver.find_element(By.XPATH, '/html/body/div[1]/div/div[1]/div/div[2]/div/div/div[1]/div/div[2]/div/div/div/div/div/div/div/div[2]/ul/div/li/div/div[2]/div[1]/div/div/span/a/span')                                                       
            #sessao_nomes_seguidores = driver.find_element(By.XPATH, '/html/body/div[1]/div/div[1]/div/div[2]/div/div/div[1]/div/div[2]/div/div/div/div/div/div/div/div[2]/ul/div/li[%s]/div/div[2]/div/div/div/span/a/span' % i)
