...
class instagramBot:
    ...
    def seguindo(self, perfil_instagram):
        ...
        sessao_total_seguindo = driver.find_element(By.XPATH, '//*[@id="react-root"]/section/main/div/header/section/ul/li[3]/a')
        ...
        for i in range(1, int(total_seguindo)):
            ...
            sessao_nomes_seguindo = driver.find_element(By.XPATH, '/html/body/div[6]/div/div/div[2]/ul/div/li[%s]' % i) #captura o nome do seguidor
            driver.execute_script("arguments[0].scrollIntoView();", sessao_nomes_seguindo)
            driver.switch_to.active_element
            seguindo = driver.find_elements(By.XPATH, '//*[contains(text(), "Seguir")]')
